...
folder='D:/paper_material/2d/model_weights_10_10_normalize.h5'#load model
...
for n in range(10):
    ...
    for k in loc:
        ...
        reconstruct_MML_matrix = np.array(reconstruct_MML_matrix)>threshold2#if need abs or not??
