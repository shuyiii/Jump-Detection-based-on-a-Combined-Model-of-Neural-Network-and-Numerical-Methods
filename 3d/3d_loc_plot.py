...
for i in range(21):
    ...
    ax.scatter3D(np.asarray([c[2]+0.5 for c in loc_loc]), np.asarray([c[1]+0.5 for c in loc_loc]), np.asarray([c[0]+0.5 for c in loc_loc]),color='green')
    #ax.plot3D(np.asarray([c[2]+0.5 for c in loc_loc]), np.asarray([c[1]+0.5 for c in loc_loc]), np.asarray([c[0]+0.5 for c in loc_loc]),color='green',linewidth=1)
