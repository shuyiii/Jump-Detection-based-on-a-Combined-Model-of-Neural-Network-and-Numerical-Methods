...
#generate reconstruct matrix
    ...
    for q in loc_t:
        ...
        y1 = q[1]
        x1 = q[2]
        Xx,Yy,Zz=(x0[j]+x1)/100, (y0[j]+y1)/100, (z0[j]+z1)/100
        ax.plot3D([Xx,Xx+0.01], [Yy,Yy], [Zz,Zz], 'red')
        ax.plot3D([Xx,Xx+0.01], [Yy+0.01,Yy+0.01], [Zz,Zz], 'red')
        ax.plot3D([Xx,Xx+0.01], [Yy,Yy], [Zz+0.01,Zz+0.01], 'red')
        ax.plot3D([Xx,Xx+0.01], [Yy+0.01,Yy+0.01], [Zz+0.01,Zz+0.01], 'red')
        ax.plot3D([Xx,Xx], [Yy,Yy+0.01], [Zz,Zz], 'red')
        ax.plot3D([Xx+0.01,Xx+0.01], [Yy,Yy+0.01], [Zz,Zz], 'red')
        ax.plot3D([Xx,Xx], [Yy,Yy+0.01], [Zz+0.01,Zz+0.01], 'red')
        ax.plot3D([Xx+0.01,Xx+0.01], [Yy,Yy+0.01], [Zz+0.01,Zz+0.01], 'red')
        ax.plot3D([Xx,Xx], [Yy,Yy], [Zz,Zz+0.01], 'red')
        ax.plot3D([Xx+0.01,Xx+0.01], [Yy,Yy], [Zz,Zz+0.01], 'red')
        ax.plot3D([Xx,Xx], [Yy+0.01,Yy+0.01], [Zz,Zz+0.01], 'red')
        ax.plot3D([Xx+0.01,Xx+0.01], [Yy+0.01,Yy+0.01], [Zz,Zz+0.01], 'red')
    plt.subplots_adjust(top=0.95,bottom=0.05,left=0.05,right=0.95,hspace=0,wspace=0) 
    plt.margins(0,0)
    plt.show()
    plt.savefig('D:/paper_material/paper/figure/3d 2nd step ('+str(i)+').pdf')
    plt.close()